...
$apps = @(
	...
	# Jeux et plateformes
	"Amazon.Games",                    # Amazon Games : plateforme de jeux
	"ElectronicArts.EADesktop",        # EA App : client de jeux EA
	"EpicGames.EpicGamesLauncher",     # Epic Games Launcher
	"Playnite.Playnite",               # Playnite : bibliothèque de jeux unifiée
	"Valve.Steam",                     # Steam : plateforme de jeux
	"Ubisoft.Connect",                 # Ubisoft Connect
	"GOG.Galaxy",                      # GOG Galaxy
	
	# Monitoring et overclocking
	"Guru3D.RTSS",                     # RTSS : overlay et statistiques en jeu
	"Guru3D.Afterburner"               # MSI Afterburner : monitoring & overclocking GPU
)
